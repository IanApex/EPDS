...
const meta = {
    ...
    docs: {
      description: {
        component:
          ...
          '**Variants:** `error`, `warning`, `success`, `info`, `notification`\n\n' +
  ...
  argTypes: {
    variant: { control: 'radio', options: ['error', 'warning', 'success', 'info', 'notification'] },
    title:   { control: 'text' },
  },
  args: {
    variant: 'info',
...
export const AllVariants: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'All five variants stacked for visual comparison.',
      },
    },
  },
  render: () => ({
    ...
    template: `
      <div style="padding:24px;max-width:600px;display:flex;flex-direction:column;gap:16px;">
        ...
        <BaseAlert variant="info"         title="Just so you know">Prices shown include all fees except tax, title, and registration.</BaseAlert>
