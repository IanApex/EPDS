...
export const tokens = {
  ...
  semantic: {
    action: {
      ...
      primaryVivid:   v('color-action-primary-vivid'),
      ...
      accentActive:   v('color-action-accent-active'),
      accentMuted:    v('color-action-accent-muted'),
      accentTint:     v('color-action-accent-tint'),
